"""Group-level feature aggregation for TFT.
...
class TickerGroupFeatureAggregator:
    ...
    def compute_group_features(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        for group_name, group_config in self.ticker_groups.items():
            ...
            # Note: trend200_mean removed based on config (user removed it)
            # But keep the logic here in case they want to add it back
